<x-app-layout>
    @section('header', 'Actualizar Voluntario')
    <div class="ui container a-p-12">
        <form class="ui form">
            ...
            <div class="field full">
                ...
                <input type="text" placeholder="Nombre" name="name" required value="{{old('name', $volunteer->name)}}">
            </div>
            <div class="three fields">
                <div class="field">
                    <label>Numero de Teléfono</label>
                    <input type="tel" name="phone_number" placeholder="Numero de Teléfono" required value="{{old('phone_number', $volunteer->phone_number)}}">
                </div>
                <div class="field">
                    <label>Email</label>
                    <input type="email" name="email" placeholder="Email" required value="{{old('email', $volunteer->email)}}">
                </div>
            </div>
            {{--Basic Info--}}
            {{-- Action --}}
