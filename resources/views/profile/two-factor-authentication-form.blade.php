<x-jet-action-section>
    ...
    <x-slot name="description">
        {{ __('Agregue seguridad adicional a su cuenta usando la autenticación de dos factores Agregue seguridad adicional a su cuenta usando la autenticación de dos factores.') }}
    </x-slot>
